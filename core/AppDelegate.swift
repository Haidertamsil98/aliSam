...
//  core
//
//  Created by Haider Tamsil on 26/04/18.
//  Copyright © 2018 Haider Tamsil. All rights reserved.
//
...
//            print("hello", Services.ServicesInstance.getToken())
            VC = storyboard.instantiateViewController(withIdentifier: "toolbar") as! HB
