...
//  SoundWave
//
//  Created by HaiderTamsil. on 12/6/21.
...
extension UIColor {
	...
	static var audioVisualizationPurpleGradientStart: UIColor {
        return UIColor(red: 00.0 / 255.0, green: 00.0 / 255.0, blue: 127.0 / 255.0, alpha: 1.0)
	}
	
	static var audioVisualizationPurpleGradientEnd: UIColor {
		return UIColor(red: 00.0 / 255.0, green: 00.0 / 255.0, blue: 190.0 / 255.0, alpha: 1.0)
	}
